...
A MVP with ViewModel library using RxJava and RxAndroid. Along the way some of the greatly skilled and smart
android application developers and engineers have contributed both code and concepts to describing different
parts of this puzzle and credit to them is listed in the credits and this library is better due to them paving the
way.
...
```groovy
compile 'com.github.shareme:GWSDJinn:{latest-release-number}@aar'
```
